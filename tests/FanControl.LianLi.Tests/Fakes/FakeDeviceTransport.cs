...
internal sealed class FakeDeviceTransport : IDeviceTransport {
    ...
    /// <summary>When set, <see cref="Write"/> throws for each report it returns true for.</summary>
    ...
    /// <summary>When set, <see cref="Dispose"/> throws this after marking the transport disposed.</summary>
